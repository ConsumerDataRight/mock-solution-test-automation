namespace ConsumerDataRight.ParticipantTooling.MockSolution.TestAutomation.Exceptions.AuthoriseExceptions
{
    ...
    {
        public UnsupportedRequestUriFormParameterException()
            : base(Constants.ErrorMessages.Par.ParRequestUriFormParameterNotSupported)
        {
        }
    }

    public class MissingResponseModeException : InvalidRequestException
    {
        public MissingResponseModeException()
            : base(Constants.ErrorMessages.Par.MissingResponseMode)
        {
        }
    }
    ...
    public class UnsupportedResponseModeException : InvalidRequestException
    {
        public UnsupportedResponseModeException()
            : base(Constants.ErrorMessages.General.UnsupportedResponseMode)
        {
        }
    }
    ...
    public class UnsupportedResponseTypeException : InvalidRequestException
    {
        public UnsupportedResponseTypeException()
            : base(Constants.ErrorMessages.General.UnsupportedResponseType)
        {
        }
    }
    ...
    public class MissingResponseTypeException : InvalidRequestException
    {
        public MissingResponseTypeException()
            : base(Constants.ErrorMessages.General.MissingResponseType)
        {
        }
    }
    ...
    public class MissingOpenIdScopeException : InvalidRequestException
    {
        public MissingOpenIdScopeException()
            : base("OpenID Connect requests MUST contain the openid scope value.") // TODO: Should a error gen code and add to constants. Bug 64146
        {
        }
    }
    ...
    public class MissingAuthorizationCodeException : InvalidRequestException
    {
        public MissingAuthorizationCodeException()
            : base(Constants.ErrorMessages.General.MissingCode)
        {
        }
    }
    ...
    {
        public InvalidRedirectUriForClientException()
            : base(Constants.ErrorMessages.General.InvalidRedirectUri)
        {
        }
    }
    ...
    {
        public UnsupportedResponseTypeRedirectException()
            : base("Unsupported response_type", HttpStatusCode.Redirect) // TODO: Should a error gen code and add to constants. Bug 64146
        {
        }
    }
    ...
    {
        public InvalidClientIdRedirectException()
            : base("Invalid client ID.", HttpStatusCode.Redirect) // TODO: Should a error gen code and add to constants. Bug 64146
        {
        }
    }
    #endregion
