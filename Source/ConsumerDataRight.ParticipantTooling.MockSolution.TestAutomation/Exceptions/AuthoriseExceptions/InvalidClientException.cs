namespace ConsumerDataRight.ParticipantTooling.MockSolution.TestAutomation.Exceptions.AuthoriseExceptions
{
    ...
    public class ClientNotFoundException : InvalidClientException
    {
        public ClientNotFoundException()
            : base(Constants.ErrorMessages.General.ClientNotFound)
        {
        }
    }
    ...
    {
        public MissingClientAssertionException()
            : base(Constants.ErrorMessages.General.ClientAssertionNotProvided)
        {
        }
    }
    ...
    {
        public MissingClientAssertionTypeException()
            : base(Constants.ErrorMessages.ClientAssertion.ClientAssertionTypeNotProvided)
        {
        }
    }
    ...
    {
        public InvalidClientAssertionTypeException()
            : base(Constants.ErrorMessages.ClientAssertion.InvalidClientAssertionType)
        {
        }
    }
    ...
    public class InvalidClientAssertionFormatException : InvalidClientException
    {
        public InvalidClientAssertionFormatException()
            : base(Constants.ErrorMessages.ClientAssertion.ClientAssertionInvalidFormat)
        {
        }
    }
    ...
    {
        public MissingIssClaimException()
            : base(Constants.ErrorMessages.ClientAssertion.ClientAssertionMissingIssClaim)
        {
        }
    }
    ...
    {
        public MissingJtiException()
            : base(Constants.ErrorMessages.General.JtiRequired)
        {
        }
    }
    ...
    {
        public TokenValidationClientAssertionException()
            : base(Constants.ErrorMessages.Jwt.JwtValidationErro.Replace("{0}", "client_assertion"))
        {
        }
    }
    ...
    public class InvalidAudienceException : InvalidClientException
    {
        public InvalidAudienceException()
            : base(Constants.ErrorMessages.Jwt.JwtInvalidAudience.Replace("{0}", "client_assertion"))
        {
        }
    }
    ...
    {
        public ExpiredClientAssertionException()
            : base(Constants.ErrorMessages.Jwt.JwtExpired.Replace("{0}", "client_assertion"))
        {
        }
    }
}
