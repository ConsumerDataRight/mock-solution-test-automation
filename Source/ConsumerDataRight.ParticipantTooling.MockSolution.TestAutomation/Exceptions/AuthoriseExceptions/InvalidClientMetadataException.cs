namespace ConsumerDataRight.ParticipantTooling.MockSolution.TestAutomation.Exceptions.AuthoriseExceptions
{
    ...
    {
        public AuthorizationSignedResponseAlgClaimInvalidException()
            : base("The 'authorization_signed_response_alg' claim value must be one of 'PS256,ES256'.") // TODO: Should a error gen code and add to constants. Bug 64146
        {
        }
    }
    ...
    public class AuthorizationSignedResponseAlgClaimMissingException : InvalidClientMetadataException
    {
        public AuthorizationSignedResponseAlgClaimMissingException()
            : base("The 'authorization_signed_response_alg' claim is missing.") // TODO: Should a error gen code and add to constants. Bug 64146
        {
        }
    }
    ...
    {
        public TokenEndpointAuthSigningAlgClaimInvalidException()
            : base("The 'token_endpoint_auth_signing_alg' claim value must be one of 'PS256,ES256'.") // TODO: Should a error gen code and add to constants. Bug 64146
        {
        }
    }
    ...
    {
        public DuplicateRegistrationForSoftwareIdException()
            : base(Constants.ErrorMessages.Dcr.DuplicateRegistration)
        {
        }
    }
    ...
    {
        public GrantTypesMissingAuthorizationCodeException()
            : base("The 'grant_types' claim value must contain the 'authorization_code' value.") // TODO: Should a error gen code and add to constants. Bug 64146
        {
        }
    }
}
